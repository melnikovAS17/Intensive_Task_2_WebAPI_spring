package ru.melnikov.intensive.configs;
...
@Configuration
@ComponentScan("ru.melnikov.intensive")
@EnableWebMvc
@PropertySource("classpath:hibernate.properties")
@EnableTransactionManagement
@EnableJpaRepositories("ru.melnikov.intensive.repositories")
public class SpringConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("ru.melnikov.intensive.models");
